...
\caption{\label{fig:key:1.1} A mixed methods triangulation research design using the convergence model, by courtesy of Gustavo Daniel Constantino and Slideshare.net, based on \citealt{CreswellPlanoClark2007}: 63 © 2012, Gustavo Daniel Constantino; used with permission. }
\end{figure}
